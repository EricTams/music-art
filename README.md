...
sheets (yellow, orange, red and grey, front to back, 12 × 20 in, ⅛″ thick,
Glowforge's standard sheet size)
...
npm run export -- presets/12x20-glowforge.json   # or any saved preset
```
